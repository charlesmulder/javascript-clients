...
- ⚠️  **@redhat-cloud-services/host-inventory-client:** regenerate Inventory client from latest OpenAPI spec ([640172fe](https://github.com/RedHatInsights/javascript-clients/commit/640172fe))

### ⚠️  Breaking Changes

- **@redhat-cloud-services/host-inventory-client:** regenerate Inventory client from latest OpenAPI spec  ([640172fe](https://github.com/RedHatInsights/javascript-clients/commit/640172fe))
...
- Updated @redhat-cloud-services/javascript-clients-shared to 2.0.15
...
- Updated @redhat-cloud-services/javascript-clients-shared to 2.0.14

## 5.0.8 (2026-07-21)

### 🧱 Updated Dependencies

- Updated @redhat-cloud-services/javascript-clients-shared to 2.0.13
...
- Updated @redhat-cloud-services/javascript-clients-shared to 2.0.7
...
## [4.1.2](https://github.com/RedHatInsights/javascript-clients/compare/@redhat-cloud-services/host-inventory-client-4.1.1...@redhat-cloud-services/host-inventory-client-4.1.2) (2025-09-24)
