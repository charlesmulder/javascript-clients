...
runExportTests('@redhat-cloud-services/integrations-client', [
  ...
  {
    description: 'EndpointResourceV1CreateEndpoint endpoint',
    importPath: '@redhat-cloud-services/integrations-client/EndpointResourceV1CreateEndpoint',
  },
  {
    description: 'EndpointResourceV1DeleteEndpoint endpoint',
    importPath: '@redhat-cloud-services/integrations-client/EndpointResourceV1DeleteEndpoint',
  },
