 ...
 *
 * @export
 * @interface AdvisorAppData
 */
export interface AdvisorAppData {
    /**
     *
     * @type {number}
     * @memberof AdvisorAppData
     */
 ...
 *
 * @export
 * @interface ComplianceAppData
 */
export interface ComplianceAppData {
    /**
     *
     * @type {Array<object>}
 ...
 * @export
 * @interface ConsumerApplicationsData
 */
export interface ConsumerApplicationsData {
    /**
     *
     * @type {AdvisorAppData}
     * @memberof ConsumerApplicationsData
     */
 ...
 * @export
 * @interface HostViewFilterComparison
 */
export interface HostViewFilterComparison {
    /**
     *
     * @type {string}
     * @memberof HostViewFilterComparison
     */
    'eq'?: string;
    /**
     *
    ...
    'lte'?: string;
    /**
     * When true, matches hosts where this field is null/missing.
     * @type {boolean}
     * @memberof HostViewFilterComparison
     */
    'nil'?: boolean;
    /**
     * When true, matches hosts where this field exists and is not null.
     * @type {boolean}
     * @memberof HostViewFilterComparison
     */
    'not_nil'?: boolean;
 ...
 *
 * @export
 * @interface HostViewHost
 */
export interface HostViewHost {
    /**
     * An ID defined in /etc/insights-client/machine-id. This field is considered a canonical fact.
     * @type {string}
 ...
 *
 * @export
 * @interface MalwareAppData
 */
export interface MalwareAppData {
    /**
     *
     * @type {string}
     * @memberof MalwareAppData
     */
...
export interface NotFoundErrorResponse {
    ...
    'detail': string;
    /**
     * A list of IDs that were requested but not found. This field is included when specific IDs can be identified as missing.
     * @type {Array<string>}
     * @memberof NotFoundErrorResponse
     */
 ...
 *
 * @export
 * @interface PatchAppData
 */
export interface PatchAppData {
    /**
     *
     * @type {number}
     * @memberof PatchAppData
     */
    'advisories_rhsa_applicable'?: number | null;
    /**
     *
     * @type {number}
     * @memberof PatchAppData
     */
    'advisories_rhba_applicable'?: number | null;
    /**
     *
     * @type {number}
     * @memberof PatchAppData
     */
    'advisories_rhea_applicable'?: number | null;
    /**
     *
     * @type {number}
     * @memberof PatchAppData
     */
    'advisories_other_applicable'?: number | null;
    /**
     *
     * @type {number}
     * @memberof PatchAppData
     */
    'advisories_rhsa_installable'?: number | null;
    /**
     *
     * @type {number}
     * @memberof PatchAppData
     */
    'advisories_rhba_installable'?: number | null;
    /**
     *
     * @type {number}
     * @memberof PatchAppData
     */
    'advisories_rhea_installable'?: number | null;
    /**
     *
     * @type {number}
     * @memberof PatchAppData
     */
    'advisories_other_installable'?: number | null;
    /**
     *
     * @type {number}
     * @memberof PatchAppData
     */
    'packages_applicable'?: number | null;
    /**
     *
     * @type {number}
     * @memberof PatchAppData
     */
    'packages_installable'?: number | null;
    /**
     *
     * @type {number}
     * @memberof PatchAppData
 ...
 *
 * @export
 * @interface RemediationsAppData
 */
export interface RemediationsAppData {
    /**
     *
     * @type {number}
     * @memberof RemediationsAppData
     */
    'remediations_plans'?: number | null;
}
/**
 ...
 */
export interface VulnerabilityAppData {
    /**
     *
     * @type {number}
     ...
     * @memberof VulnerabilityAppData
     */
    'cves_with_security_rules'?: number | null;
    /**
     *
     * @type {number}
     * @memberof VulnerabilityAppData
     */
    'cves_with_known_exploits'?: number | null;
}
